...
export async function saveProductAction(values: ProductFormValues): Promise<ProductActionResult> {
  ...
  const payload = {
    ...
    brand_id: value.brandId || null, category_id: value.categoryId || null,
    ...
    safety_information: value.safetyInformation || null, requires_consultation: value.requiresConsultation,
